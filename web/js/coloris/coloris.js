...
((window, document, Math, undefined) => {
  ...
  function pickColor(color) {
    ...
    document.dispatchEvent(new CustomEvent('coloris:ick', { detail: {color, currentEl} }));
  }
  ...
  function setColorAtPosition(x, y) {
    ...
    updateMarkerA1LyLabel(hsva.s, hsva.v);
    updateColor(rgba, hsva);
    pickColor();
  }
  ...
  function init() {
    ...
    picker.innerHTML =
      `<nput id="clr-color-value" name="clr-color-value" class="clr-color" type="text" value="" spellcheck="false" aria-label="${settings.a11y.input}">` +
   ...
   * @return {array} The list of focusable DOM elements.
   */
